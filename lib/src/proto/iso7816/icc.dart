...
class ICC {
  ...
  Future<Uint8List> generalAuthenticatePACEstep1({
    required Uint8List data,
    int ne = 256,
    int cla = ISO7816_CLA.COMMAND_CHAINING,
  }) async {
    //4.4.4.2 GENERAL AUTHENTICATE
    _log.sdVerbose(
      "Sending GENERAL AUTHENTICATE - step 1 command to ICC"
      " data='${data.hex()}'"
      " ne=$ne"
      " cla=${cla.hex()}",
    );
  ...
  Future<Uint8List> generalAuthenticatePACEstep2and3({
    ...
    //4.4.4.2 GENERAL AUTHENTICATE
    _log.sdVerbose(
      "Sending GENERAL AUTHENTICATE - step 2 or 3' command to ICC"
      " data='${data.hex()}'"
      " ne=$ne"
      " cla=${cla.hex()}",
    );
  ...
  Future<Uint8List> generalAuthenticatePACEstep4({
    ...
    //4.4.4.2 GENERAL AUTHENTICATE
    _log.sdVerbose(
      "Sending GENERAL AUTHENTICATE - step 4' command to ICC"
      " data='${data.hex()}'"
      " ne=$ne"
      " cla=${cla.hex()}",
    );
